...
;; Triangular numbers  - generated by adding the first 'n' natural
;; numbers:
;; 1st 1   => 1
;; 2nd 1 + 2 => 3
;; 3rd 1 + 2 + 3 => 6
...
(defn triangular?
  "Is the number triangular? e.g. 1, 3, 6, 10, 10, 15"
  [n]
...
(defn row-num
  "Returns row number the positon belongs to: pos 1 in row 1,
...
(defn connect
  "Form a mutual connection between two postions"
